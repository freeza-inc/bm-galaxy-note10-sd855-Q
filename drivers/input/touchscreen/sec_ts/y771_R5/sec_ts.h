...
#define SEC_GESTURE_ID_FOD_LONG				0x00
#define SEC_GESTURE_ID_FOD_NORMAL			0x01
#define SEC_GESTURE_ID_FOD_RELEASE			0x02
#define SEC_GESTURE_ID_FOD_OUT				0x03
...
#define SEC_TS_SET_EAR_DETECT_MODE	0x41
...
enum {
	...
	TYPE_DECODED_REMAPPED_DATA	= 51,	/* TYPE_DECODED_DATA after Remap */
	TYPE_RAWDATA_MAX,
	TYPE_INVALID_DATA		= 0xFF,	/* Invalid data type for release factory mode */
};

enum layer_remap {
	TYPE_REMAP			= 0, /* REMAP RX TX */
	TYPE_UNMAP			= 1, /* UNREMAP RX TX */
	TYPE_UNMAP_FORSELF		= 2, /* ONLY REMAP IN MUTUAL */
};

extern int layer_data[TYPE_RAWDATA_MAX];

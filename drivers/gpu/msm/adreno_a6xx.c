...
/*
 * a6x_gpc_err_int_callback() - Isr for GPC error interrupts
 * @adreno_dev: Pointer to device
 * @bit: Interrupt bit
 */
void a6x_gpc_err_int_callback(struct adreno_device *adreno_dev, int bit)
{
	struct kgsl_device *device = KGSL_DEVICE(adreno_dev);
...
static struct adreno_irq_funcs a6xx_irq_funcs[32] = {
	...
	ADRENO_IRQ_CALLBACK(a6x_gpc_err_int_callback), /* 7 - GPC_ERR */
